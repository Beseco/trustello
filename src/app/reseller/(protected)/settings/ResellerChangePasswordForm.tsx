...
import { changeResellerPassword } from "@/server/actions/reseller-settings";
import {
  Form,
  FormControl,
  FormField,
...
export function ResellerChangePasswordForm() {
  ...
  async function onSubmit(data: FormData) {
    setServerError(null);
    setSuccess(false);
    const result = await changeResellerPassword(data);
